...
const BarChart = ({ isDashboard = false }) => {
  ...
  return (
    <>
      {console.log(haircutsBydateAndHairCutsCount)}
      <ResponsiveBar
        data={haircutsBydateAndHairCutsCount}
        theme={{
          axis: {
            domain: {
              line: {
        ...
        axisBottom={{
          ...
          tickPadding: 5,
          tickRotation: 0,
          legend: isDashboard ? undefined : "Month Number", // changed
        ...
        axisLeft={{
          ...
          tickPadding: 5,
          tickRotation: 0,
          legend: isDashboard ? undefined : "HairCuts num", // changed
          legendPosition: "middle",
          legendOffset: -40,
        }}
        enableLabel={false}
