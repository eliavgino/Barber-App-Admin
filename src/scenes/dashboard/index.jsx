...
const Dashboard = () => {
  ...
  return (
    <Box m="20px">
      ...
      {console.log(allHairCuts[0].barber["barber_Name"])}
      {console.log(allHairCuts[0].barber["product_name"])}
      {console.log(allHairCuts[0].barber["product_price"])}
      {console.log(allHairCuts[0].date)}
      {console.log(allHairCuts[0].user["user_Name"])}
      ...
      >
        ...
        >
          <StatBox
            ...
            progress={`0.${(count["count"] - count2["count"]) / 100}`}
            increase={`+${(count["count"] - count2["count"]) / 100}%`}
            icon={
              <SummarizeIcon
                sx={{ color: colors.greenAccent[600], fontSize: "26px" }}
              />
